...
val retyping : Syntax.term -> Syntax.typ list -> Parser_wrapper.orig * Syntax.term
val extract_id : Syntax.term -> Syntax.id

val to_holed_programs :
  Syntax.term (* target program *) -> BRA_types.holed_program list (* holed transformed program *)
