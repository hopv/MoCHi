...
val inv_fdef :
  Fpat.Fdef.t -> string * Fpat.Pattern.t list * CEGAR_syntax.t * 'a list * CEGAR_syntax.t
...
val implies : ?tenv:Fpat.TypEnv.t -> Fpat.Formula.t list -> Fpat.Formula.t list -> bool
...
val instantiate_param :
  CEGAR_syntax.prog -> CEGAR_syntax.env * CEGAR_syntax.fun_def list * CEGAR_syntax.var
...
val trans_ext :
  ...
  int * CEGAR_util.ext_path_part list list ->
  Fpat.Idnt.t * Fpat.Pred.t list
