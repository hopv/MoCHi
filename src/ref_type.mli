...
type t =
  ...
  | Record of (string * (Type.mutable_flag * t)) list
  | Exn of t * t
and constr = string
...
(** {6 Transformation} *)
val make_trans : ?tr:Syntax.trans -> ((t -> t) -> t -> t option) -> t -> t
val simplify : t -> t
...
val replace_data_with_int_but_exn : constr list -> t -> t
...
val subst_adt : ?force:bool -> string -> t -> t -> t
