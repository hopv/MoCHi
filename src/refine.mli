...
val add_renv :
  (int * (CEGAR_syntax.t -> CEGAR_syntax.t list)) list -> CEGAR_syntax.env -> CEGAR_syntax.env
...
val refine_rank_fun :
  CEGAR_syntax.ce -> (Fpat.Idnt.t * Fpat.Pred.t list) list -> CEGAR_syntax.prog -> unit
