...
let or_cps = "or_cps"
let not_cps = "not_cps"
let and_def = {fn=and_cps; args=["x"; "y"; "k"]; cond=Const True; body=Term.(if_ (var "x") (var "k" @ [var "y"]) (var "k" @ [false_]))}
let or_def = {fn=or_cps; args=["x"; "y"; "k"]; cond=Const True; body=Term.(if_ (var "x") (var "k" @ [true_]) (var "k" @ [var "y"]))}
let not_def = {fn=not_cps; args=["x"; "k"]; cond=Const True; body=Term.(if_ (var "x") (var "k" @ [false_]) (var "k" @ [true_]))}
...
let to_funs_def {fn; args=xs; cond; body=t2} = {fn; args=[]; cond; body=List.fold_right (fun x t-> Fun(x,None,t)) xs t2}
