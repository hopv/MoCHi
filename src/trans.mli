...
val inst_tvar : typ -> term -> unit
val inst_tvar_typ : typ -> typ -> unit
...
val set_main_for : ?force:bool -> id list -> term -> term
...
val replace_data_with_int_but : typ option -> term -> term
...
val inline_simple_types : term -> (string * typ) list * term
...
val copy_por : term -> term
val merge_deref : term -> term
